$(function(){
    var eleWidth = $(".frame_best>ul>li").innerWidth();
    ...
    function play(){ 
        ...
        if(playOn){
            $(".frame_best>ul>li>a").mouseover(function(){
                stop();
            }); //플레이 상태
        }//if(playOn)
    ...
    function stop (){
        ...
        $(".frame_best>ul>li>a").mouseout(function(){
            play();
        });

        $(".frame_best>ul>li>a").click(function(){
            location.href; //이동한다
        });
    ...
    function left(){
        ...
        $(".frame_best>ul").animate({left:eleWidth*-1},500,function(){
    ...
    function right(){
        ...
        $(".frame_best>ul>li:last").insertBefore($(".frame_best>ul>li:first"));
        $(".frame_best>ul").css("left",eleWidth*-1);
        $(".frame_best>ul").animate({left:0},500,function(){
            state=false;
            play();
        });
    }//right
